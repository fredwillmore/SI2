...
front = jbox.panel{
    ...
    widgets = {
        ...
        jbox.analog_knob{
            transform = {616,42},
            margins = {left = 12, top = 12, right = 12, bottom = 12},
            animation = jbox.image_sequence{path = "Reason_GUI_front_root_Knob_Volume", frames = 63},
        ...
        jbox.analog_knob{
            ...
            animation = jbox.image_sequence{path = "Reason_GUI_front_root_Display_Waveform", frames = 3},
